          ...
          return (
            ...
            >
              ...
              <div className="flex items-center flex-1 mr-3">
                {/* Choice Identifier */}
                <div
                  className={`w-7 h-7 rounded-[8px] flex items-center justify-center font-bold text-[12px] shrink-0 mr-4 transition-colors ${
              ...
              <div className="flex items-center gap-2 shrink-0">
                {!isSubmitted && (
                  <button
                    ...
                    className={`w-8 h-8 rounded-full border flex items-center justify-center font-mono text-xs font-bold transition-all cursor-pointer ${
                      isCrossed
      ...
      <div className="px-6 py-3.5 bg-[#F1F8F7] border-b border-[#E2E8F0] flex flex-wrap items-center justify-between gap-3 text-[12px]">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`h-9 px-3.5 flex items-center gap-1.5 rounded-[8px] border transition-colors font-semibold text-[12px] cursor-pointer ${
              isCrossOutModeActive
          ...
          <button
            ...
            className={`h-9 px-3 flex items-center gap-1.5 rounded-[8px] border transition-colors cursor-pointer ${
              isMarkedForReview
