...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full transition-all duration-200 bg-[#0D918A] border-b border-[rgba(255,255,255,0.15)] shadow-xs">
            ...
            {!currentUser ? (
              ...
              <>
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    isLinkActive('home') ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                  <span>Home</span>
                  {isLinkActive('home') && (
                ...
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    isLinkActive('practice') ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                  <span>Practice</span>
                ...
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    isLinkActive('mock-tests') ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    isLinkActive('courses') ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                  <span>Courses</span>
                ...
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    isLinkActive('pricing') ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                  <span>Pricing</span>
              ...
              <>
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    currentView === 'admin-dashboard' ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                  <span>Overview</span>
                ...
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    currentView === 'admin-students' ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                  <span>Students</span>
                ...
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    currentView === 'admin-purchases' ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    currentView === 'admin-questions' ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
              ...
              <>
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    isLinkActive('dashboard') ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                  <span>Dashboard</span>
                ...
                <button
                  ...
                  className={`relative py-2 text-sm transition-colors duration-150 cursor-pointer ${
                    isLinkActive('progress') ? 'text-white font-semibold' : 'text-white/80 hover:text-white'
                  }`}
                >
                  <span>Analytics</span>
                ...
                >
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg transition-colors cursor-pointer ${
                      theme === 'white' ? 'bg-slate-50 text-[#071126] font-semibold' : 'text-[#58708A] hover:bg-slate-50'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg transition-colors cursor-pointer ${
                      theme === 'warm' ? 'bg-amber-50/60 text-amber-900 font-semibold' : 'text-[#58708A] hover:bg-slate-50'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-3 py-2 rounded-lg transition-colors cursor-pointer ${
                      theme === 'dark' ? 'bg-slate-900 text-white font-semibold' : 'text-[#58708A] hover:bg-slate-50'
                    }`}
                  >
