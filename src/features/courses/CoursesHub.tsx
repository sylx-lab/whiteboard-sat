      ...
      <div className="max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
        {courses.map((course, index) => {
          ...
          return (
            <div
              key={course.id}
              className={`relative rounded-2xl p-7 flex flex-col justify-between transition-all duration-200 hover:-translate-y-1 group overflow-hidden ${
                isFlagship
            ...
            >
              ...
              <div className="space-y-5 relative z-10">
                ...
                <div className="flex items-center justify-between">
                  <span
                    className={`px-3 py-1 rounded-md text-[11.5px] font-semibold tracking-wide uppercase ${
                      isFlagship
                    ...
                    <div className="flex items-center justify-between pt-1">
                      ...
                      {hasAccessToCourse(selectedCourse.id) && (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-[11px] font-medium border transition-colors flex items-center gap-1.5 cursor-pointer ${
