        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex rounded-[10px] bg-[#F8FAFC] p-1 text-[12px] font-medium border border-[#E3E8F0]">
            <button
              ...
              className={`px-3.5 py-1.5 rounded-[8px] transition-all cursor-pointer ${
                historyFilter === 'all' ? 'bg-white text-[#071126] font-semibold shadow-2xs' : 'text-[#58708A]'
              }`}
            >
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-[8px] transition-all cursor-pointer ${
                historyFilter === 'correct' ? 'bg-white text-emerald-700 font-semibold shadow-2xs' : 'text-[#58708A]'
              }`}
            >
              Correct
            </button>
            <button
              ...
              className={`px-3.5 py-1.5 rounded-[8px] transition-all cursor-pointer ${
                historyFilter === 'incorrect' ? 'bg-white text-rose-700 font-semibold shadow-2xs' : 'text-[#58708A]'
              }`}
            >
              Incorrect
            </button>
