        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
          {plans.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={`rounded-[16px] p-6 flex flex-col justify-between h-full transition-all duration-160 relative ${
                  isFeatured
              ...
              >
                ...
                <div className="pt-6 mt-auto">
                  <button
                    ...
                    className={`w-full py-2.5 rounded-[10px] font-semibold text-[13px] transition-colors flex items-center justify-center gap-1.5 cursor-pointer group/btn ${
                      isFeatured
